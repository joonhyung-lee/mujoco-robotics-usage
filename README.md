...
* Demos
  ...
  2. [UR5e / Franka Interaction MPC](code/manipulator/TABLE_TRANSFER.md)
        * Move an upright bar from Table A to Table B with the repository RG2 gripper, using either wall avoidance or contact recovery.
        * Estimate end-effector wrench from joint state and torque data, then run the same MPC for compliant transport.
